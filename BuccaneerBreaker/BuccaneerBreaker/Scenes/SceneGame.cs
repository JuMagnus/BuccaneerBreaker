...
namespace BuccaneerBreaker
{
    public class SceneGame : Scene
    {
        ...
        //Récupération des briques depuis les fichiers json
        ...
        //coup de cannon du cannonball
        private void OnCannonBallLaunched(object source, EventArgs args)
        {
            Vector2 launchPosition = new Vector2(_paddle.position.X + _paddle.colliderBox.Width / 2, _paddle.position.Y - _paddle.colliderBox.Height);
        ...
        private void UpdateLife(int life)
        {
            ...
            for (int i = 0; i < life; i++)
            {
                ...
                Vector2 _lifePosition = new Vector2(10 + i * texture.Width, 40);
        ...
        public override void Load()
        {
            ...
            //Zone de jeu
            _gameBox = new Rectangle(50, 200, screenBox.Width - 100, screenBox.Height - 300);
            
            //Récupération dun nivau en cours
            var level = _levels.GetLevel(_levels.currentLevel);
            ...
            //Eléments de GUI
            //Dans les améliorations futures, j'aimerais que la durée du timer soit écrite dans les fichier json des niveaux pour avoir des durées variables.
            _timer = new Timer(_assets.Get<Texture2D>("TexBanner"), new Vector2(400, 25), _font, 120f);
            _timer.StartStop();
            ...
            //Abonnements aux événements du paddle
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            DrawUtils.Rectangle(new Vector2(_gameBox.X, _gameBox.Y), _gameBox.Width, _gameBox.Height, Color.Black, 4);
